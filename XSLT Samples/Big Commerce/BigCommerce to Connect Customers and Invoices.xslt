...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template name="Invoice">
    <Invoice>
      ...
      <Carriage>
        ...
        <QtyOrdered>1</QtyOrdered>
        <UnitPrice>
          <xsl:value-of select="./Shipping_Cost_inc_tax"/>
        </UnitPrice>
        <TotalNet>
          <xsl:value-of select="./Shipping_Cost_ex_tax"/>
        </TotalNet>
        <TotalTax>
          <xsl:value-of select="./Shipping_Cost_inc_tax - ./Shipping_Cost_ex_tax"/>
        </TotalTax>
        <Type>NonStock</Type>
      </Carriage>
      ...
      <PaymentAmount>
        <xsl:value-of select="./Order_Total_inc_tax"/>
      </PaymentAmount>
      <xsl:choose>
  ...
  <xsl:template name="InvoiceItem">
    <Item>
      ...
      <UnitPrice>
        <xsl:value-of select="./Product_Unit_Price"/>
      </UnitPrice>
      <xsl:choose>
